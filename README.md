...
The lab is due on **TBD, 2024**, TBD days from the release date.
...
* __Use the visualization code__: We provided an example Python script in `wall_follower` that plots a line in Rviz. Try to use this to make sure your code (e.g. wall detection) is working!
